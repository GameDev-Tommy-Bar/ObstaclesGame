...
public class KeyboardMover : MonoBehaviour
{
    ...
    [SerializeField]
    float minSpeedForFriction = 0.01f;

    [Tooltip(
        "Horizontal acceleration of friction, against the direction of movement, in meters per second^2"
    )]
    [SerializeField]
    float frictionAcceleration = 20.0f;
